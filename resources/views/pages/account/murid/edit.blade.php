                    ...
                    <div class="card-body">
                        ...
                        <form id="muridForm" name="muridForm" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="row mb-3">
                                    <input type="hidden" name="id" id="idMurid" value="{{ $murid->id }}">
                                    <div class="col-sm-6">
                                        <label class="form-label">Nama Murid</label>
                                        <input type="text" name="nama_murid" value="{{ $murid->nama_murid }}" class="form-control" id="nama_murid"
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="number" name="telepon" value="{{ $murid->telepon }}" class="form-control" id="telepon"
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" name="alamat" value="{{ $murid->alamat }}" class="form-control" id="alamat"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="jenis_kelamin" id="validationCustom03" data-placeholder="Choose ...">
